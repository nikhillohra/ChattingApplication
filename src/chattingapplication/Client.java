...
//Panel
        ...
        //profile1
        ImageIcon i4;
        i4 = new ImageIcon(ClassLoader.getSystemResource("icon/su2.png"));
        Image i5 = i4.getImage().getScaledInstance(90, 80, Image.SCALE_AREA_AVERAGING);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel profile = new JLabel(i6);
        profile.setBounds(30, 5, 75, 70);
        p1.add(profile);
...
//userName
        JLabel bat = new JLabel("Superman.Inc");
        bat.setBounds(110, 15, 200, 40);
